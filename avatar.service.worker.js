...
/** @type {string} */
const CACHE_VERSION = '1740319702|2825987312';
/** @type {string} */
const CACHE_PREFIX = 'avatar-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'avatar.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["avatar.html","avatar.js","avatar.offline.html","avatar.icon.png","avatar.apple-touch-icon.png","avatar.worker.js","avatar.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["avatar.wasm","avatar.pck"];
